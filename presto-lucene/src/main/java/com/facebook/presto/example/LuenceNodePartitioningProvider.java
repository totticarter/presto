...
import com.facebook.presto.example.LuceneBucketFunction;
import com.facebook.presto.example.LucenePartitioningHandle;
import com.facebook.presto.example.LuceneSplit;
import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableMap;

public class LuenceNodePartitioningProvider implements ConnectorNodePartitioningProvider {

    private final String connectorId;
    private final NodeManager nodeManager;
    private final int splitsPerNode;

    public LuenceNodePartitioningProvider(String connectorId, NodeManager nodeManager, int splitsPerNode)
    {
    ...
    {
        return value -> checkType(value, LuceneSplit.class, "value").getPartNumber();
    }

    @Override
    public BucketFunction getBucketFunction(ConnectorTransactionHandle transactionHandle, ConnectorSession session, ConnectorPartitioningHandle partitioningHandle, List<Type> partitionChannelTypes, int bucketCount)
    {
        long totalRows = checkType(partitioningHandle, LucenePartitioningHandle.class, "functionHandle").getTotalRows();
        ...
        return new LuceneBucketFunction(bucketCount, rowsPerBucket);
    }
