...
public class LuceneNodePartitioningProvider implements ConnectorNodePartitioningProvider{
    ...
    public LuceneNodePartitioningProvider(String connectorId, NodeManager nodeManager, int splitsPerNode)
    {
